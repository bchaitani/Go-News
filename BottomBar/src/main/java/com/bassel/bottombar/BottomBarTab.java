...
//    private static final float ACTIVE_TITLE_SCALE = 1;
    private static final float INACTIVE_FIXED_TITLE_SCALE = 1f;//0.86f;
//    private static final float ACTIVE_SHIFTING_TITLELESS_ICON_SCALE = 1f;//1.24f;
