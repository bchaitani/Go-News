package com.bassel.gonews.utils.navigation_utils;
...
/**
 * Created by basselchaitani on 2/7/18.
 */
...
public class FragmentNavigationController {
     ...
     */
    public void switchTab(@TabIndex int index, @Nullable FragmentNavigationTransactionOptions transactionOptions) throws IndexOutOfBoundsException {
     ...
     * @param transactionOptions Transaction options to be displayed
     */
    public void pushFragment(@Nullable Fragment fragment, @Nullable FragmentNavigationTransactionOptions transactionOptions) {
     ...
     * @param transactionOptions Transaction options to be displayed
     */
    public void popFragment(@Nullable FragmentNavigationTransactionOptions transactionOptions) throws UnsupportedOperationException {
     ...
     * @param transactionOptions Transaction options to be displayed
     */
    public void popFragments(int popDepth, @Nullable FragmentNavigationTransactionOptions transactionOptions) throws UnsupportedOperationException {
        if (isRootFragment()) {
     ...
     * @param transactionOptions Transaction options to be displayed
     */
    public void replaceFragment(@NonNull Fragment fragment, @Nullable FragmentNavigationTransactionOptions transactionOptions) {
     ...
     */
    @CheckResult
    private FragmentTransaction createTransactionWithOptions(@Nullable FragmentNavigationTransactionOptions transactionOptions) {
    ...
    public static final class Builder {
         ...
         */
        public Builder defaultTransactionOptions(@NonNull FragmentNavigationTransactionOptions transactionOptions) {
